            ...
            <div className='flex flex-col justify-center items-center gap-14'>
                ...
                <div className='w-[330px] md:w-[400px] bg-semi-dark-blue rounded-md p-8 flex flex-col text-white gap-6'>
                    ...
                    <form className='flex flex-col gap-6'>
                        ...
                        <input type='password' placeholder='Repeat Password' className='outline-none border-b-2 border-b-grayish-blue bg-transparent font-light indent-3 text-sm pb-1 caret-red focus:border-b-white' />
                        <button className='rounded-md bg-red py-2 font-light'>Craete an account</button>
                    </form>
